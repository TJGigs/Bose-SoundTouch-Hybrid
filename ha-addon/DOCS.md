...
- This add-on requires **host networking** (`host_network: true`) — this is what lets your physical speakers reach the add-on directly at your HA host's real LAN address for the preset backdoor. It cannot run with bridge networking.
